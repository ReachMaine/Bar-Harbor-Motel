<?php /* 
	27Mar15 zig - Add "apart from oridinary" slogan over lay 
				- add single-sidebar class to body.
	5may15 zig - add gtm code after body tag.
	5may15 zig - force SSL on page 742
*/ 
...
if (!in_array("double-sidebars", $body_classes) ) { // zig
	$body_classes[] = 'single-sidebar';
}
?>
<body <?php body_class( $body_classes ); ?> data-spy="scroll">
	...
	if( ! is_search() ) {
		 ...
		 /* zig - Add "apart from oridinary" slogan over lay */
		if ( is_front_page() ) {
			echo '<div id="slogan">';
			echo '<img class="bhm-slogan" src="'.get_stylesheet_directory_uri().'/images/apart_from_ordinary.png" width="400" height="88">';
			echo '</div>';
		}
