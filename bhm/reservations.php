...
/* mods 
 * copy of sidebar navigation page template for reservations form.
 * 16Mar15 - zig remove "return to parent" link in sidebar by commenting out avada_display_sidenav
 * 14March - redirect if dont have $_SESSION vars that we need for the reservation form....
 * 
 */
if (!$_SESSION['nitelink_roomtypes'] ) {
	wp_redirect('http://barharbormotel.com/room-rates/');
	exit;
} else {
	$logit = "<p>SESSION vars </br>";
	$logit .= "Arrive = ".$_SESSION['nitelink_arrive']."<br>";
	$logit .= "Depart = ".$_SESSION['nitelink_depart']."<br>";
	$logit .= "Adults = ".$_SESSION['nitelink_adults']."<br>";
	$logit .= "kids = ".$_SESSION['nitelink_kids']."<br>";
	$logit .= "roomtypes = ".$_SESSION['nitelink_roomtypes']."<br>";
	$logit .= "roomdesc = ".$_SESSION['nitelink_roomdesc']."<br>";
	$logit .= "prices = ".$_SESSION['nitelink_prices']."<br>";
	$logit .= "seasonnum = ".$_SESSION['nitelink_seasonnum']."<br>";
	$logit .= "</p>";
}
